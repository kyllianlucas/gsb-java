...
public class Medicament {
	...
	protected int MED_PrixEchantillon;
	...
	public Medicament(String MED_DEPOTLEGAL, String MED_NOMCOMMERCIAL, String MED_COMPOSITION,
			String MED_EFFETS, String MED_CONTREINDIC, int MED_PrixEchantillon, String FAM_CODE, String FAM_LIBELLE) {
	...
	public int getMED_PrixEchantillon() {
		return MED_PrixEchantillon;
	}

	public void setMED_PrixEchantillon(int mED_PrixEchantillon) {
