...
public class ConnexionMySql { // DAO = Data Access Object
	...
	public static void connecterBdd(){
		...
		//String url = "jdbc:mysql://192.178.1.12:3306/GSB";
		String url = "jdbc:mysql://192.179.1.12:3306/gsb_kyllian"; // url : chaine de connexion
		// try permet d'essayer de lancer la connexion
		try {Class.forName("com.mysql.cj.jdbc.Driver"); 
			//cnx = DriverManager.getConnection(url,"admindb","Passw0rd"); 
